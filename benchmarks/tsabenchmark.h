...
#ifndef TSA_BENCHMARK_H
#define TSA_BENCHMARK_H
...
#define TSA_BENCHMARK_MAIN(CUDA_BENCH, OPENCL_BENCH, CPU_BENCH) \
    TSA_BENCHMARK_BACKENDS_MAIN(CUDA_BENCH, OPENCL_BENCH, CPU_BENCH, true, true, true)

#define TSA_BENCHMARK_BACKENDS_MAIN(CUDA_BENCH, OPENCL_BENCH, CPU_BENCH, CUDA, OPENCL, CPU) \
