...
double khiva::distances::dtw(std::vector<double> t0, std::vector<double> t1) {
...
af::array khiva::distances::dtw(af::array tss) {
...
af::array khiva::distances::hamming(af::array tss) {
    // get the number of time series
    auto numOfTs = tss.dims(1);
    // the result is a squared matrix of dimensions numOfTs x numOfTs
    // which is initialised as zero.
...
af::array khiva::distances::manhattan(af::array tss) {
    // get the number of time series
    auto numOfTs = tss.dims(1);
    // the result is a squared matrix of dimensions numOfTs x numOfTs
    // which is initialised as zero.
