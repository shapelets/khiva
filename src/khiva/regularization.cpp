...
af::array khiva::regularization::groupBy(const af::array& in, af::array (*aggregationFunction)(const af::array &, const dim_t),
...
af::array khiva::regularization::groupBy(const af::array& in, af::array (*aggregationFunction)(const af::array &, const int),
                                         int nColumnsKey, int nColumnsValue) {
    auto n = in.dims(0);
