...
extern "C" {
    ...
    void find_best_n_discords(double *profile, unsigned int *index, long *length_profile, long *n, 
        ...
        tsa::matrix::findBestNDiscords(array(*length_profile, profile), array(*length_profile, index), *n, discords, discordIndices, subsequenceIndices);
    ...
    JNIEXPORT void JNICALL Java_tsa_TSA_findBestNDiscords( JNIEnv *env, jobject thisObj, jdoubleArray profile, jintArray index,
        ...
        tsa::matrix::findBestNDiscords(array(lengthProfile, inputP), array(lengthProfile, inputI), n, discords, discordIndices, subsequenceIndices);
