...
double PerpendicularDistance(const tsa::simplification::Point &pt, const tsa::simplification::Point &lineStart, const tsa::simplification::Point &lineEnd){
...
std::vector<tsa::simplification::Point> tsa::simplification::ramerDouglasPeucker(std::vector<tsa::simplification::Point> pointList, double epsilon){
...
std::vector<tsa::simplification::Point> tsa::simplification::visvalingam_simplify(std::vector<tsa::simplification::Point> pointList, int num_points_allowed){
    //variables
