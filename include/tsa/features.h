 ...
 * contains the sum of the suares values in the time series.
 */
...
/**
 * @brief Calculates the fourier coefficients of the one-dimensional discrete Fourier Transform for real input by usign
 ...
 */
af::array indexMassQuantile(af::array tss, float q);
 ...
 *
 * @return af::array Containing the time reversal asymetry statistic value in each time series.
 */
