...
/**
 * @brief Calculates mean value of a central approximation of the second derivative fro each time series in tss.
 *
 * @param tss Expects an input array whose dimension zero is the length of the time
 * series (all the same) and dimension one indicates the number of time series.
 *
 * @return af::array Returns the mean value of a central approximation of the second derivative for each time series.
 */
