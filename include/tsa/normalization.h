...
/**
 * @brief Normalizes the given time series according to its minimum and maximun value and adjusts each value within the
 * range [low, high].
 *
 * @param tss Expects an input array whose dimension zero is the length of the time series (all the same) and dimension
 * one indicates the number of time series.
 ...
 * normalized by maximun and minimun values, and scaled as per high and low parameters.
 */
...
/**
 * @brief Normalizes the given time series according to its maximun value and adjusts each value within the range
 * (-1, 1).
 *
 * @param tss Expects an input array whose dimension zero is the length of the time series (all the same) and dimension
 * one indicates the number of time series.
