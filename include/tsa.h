...
namespace features {
     ...
     */
    af::array aggregatedAutocorrelation(af::array ts, af::array (*aggregationFunction)(const af::array&, const bool, const dim_t));
...
namespace matrix {
    ...
    JNIEXPORT void JNICALL Java_tsa_TSA_findBestNDiscords(JNIEnv *env, jobject thisObj, jdoubleArray profile, jintArray index,
                                                            jlong lengthProfile, jlong n, jdoubleArray jDiscordDistances,jintArray jDiscordIndices, 
                                                            jintArray jSubsequenceIndices);
