...
void k_means_initial_values(khiva_array *tss, int *k, khiva_array *initial_centroids, khiva_array *centroids,
                            khiva_array *initial_labels, khiva_array *labels, float *tolerance, int *maxIterations) {
    ...
    khiva::clustering::kMeans(var_tss, *k, var_initial_centroids, var_initial_labels, *tolerance, *maxIterations);
...
void k_shape_initial_values(khiva_array *tss, int *k, khiva_array *initial_centroids, khiva_array *centroids,
    ...
    khiva::clustering::kShape(var_tss, *k, var_initial_centroids, var_initial_labels, *tolerance, *maxIterations);
