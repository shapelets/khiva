...
void aggregated_autocorrelation(khiva_array *array, int *aggregation_function, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void aggregated_linear_trend(khiva_array *array, long *chunkSize, int *aggregation_function, khiva_array *slope,
                             khiva_array *intercept, khiva_array *rvalue, khiva_array *pvalue, khiva_array *stderrest, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void cross_covariance(khiva_array *xss, khiva_array *yss, bool *unbiased, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var_xss;
    af::array var_yss;
...
void cross_correlation(khiva_array *xss, khiva_array *yss, bool *unbiased, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var_xss;
    af::array var_yss;
    check_and_retain_arrays(xss, yss, var_xss, var_yss);
...
void auto_correlation(khiva_array *array, long *max_lag, bool *unbiased, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void cwt_coefficients(khiva_array *array, khiva_array *width, int *coeff, int *w, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var;
    af::array var_width;
...
void energy_ratio_by_chunks(khiva_array *array, long *num_segments, long *segment_focus, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void friedrich_coefficients(khiva_array *array, int *m, float *r, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void max_langevin_fixed_point(khiva_array *array, int *m, float *r, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void partial_autocorrelation(khiva_array *array, khiva_array *lags, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var;
    af::array var_lags;
...
void percentage_of_reoccurring_datapoints_to_all_datapoints(khiva_array *array, bool *is_sorted, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void percentage_of_reoccurring_values_to_all_values(khiva_array *array, bool *is_sorted, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void quantile(khiva_array *array, khiva_array *q, float *precision, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var;
    af::array var_q;
...
void range_count(khiva_array *array, float *min, float *max, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void ratio_value_number_to_time_series_length(khiva_array *array, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void sum_of_reoccurring_datapoints(khiva_array *array, bool *is_sorted, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void sum_of_reoccurring_values(khiva_array *array, bool *is_sorted, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void time_reversal_asymmetry_statistic(khiva_array *array, int *lag, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
...
void variance_larger_than_standard_deviation(khiva_array *array, khiva_array *result, int* error_code, char* error_message) {
	try {
    af::array var = af::array(*array);
    af_retain_array(array, var.get());
